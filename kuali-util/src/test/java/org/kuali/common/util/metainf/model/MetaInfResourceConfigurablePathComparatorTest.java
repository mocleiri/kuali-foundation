...
public class MetaInfResourceConfigurablePathComparatorTest {
    ...
    public void test() {
        ...
        Comparator comparator = MetaInfResourceConfigurablePathComparator.builder().qualifierOrder(qualifierOrder).build();
    ...
    public void test2() {
        ...
        Comparator comparator = MetaInfResourceConfigurablePathComparator.builder().locationOrder(locationOrder).build();
        Collections.sort(resources, comparator);
        Assert.assertEquals(loc0, resources.get(0).getLocation());
        Assert.assertEquals(loc1, resources.get(1).getLocation());
    }
    ...
    public void test3() {
        ...
        Comparator comparator = MetaInfResourceConfigurablePathComparator.builder().typeOrder(typeOrder).build();
        Collections.sort(resources, comparator);
        Assert.assertEquals(loc0, resources.get(0).getLocation());
        Assert.assertEquals(loc1, resources.get(1).getLocation());
    ...
    public void test4() {
        ...
        Comparator comparator = builder.qualifierOrder(qualifierOrder).locationOrder(locationOrder).typeOrder(typeOrder).build();
        Collections.sort(resources, comparator);
