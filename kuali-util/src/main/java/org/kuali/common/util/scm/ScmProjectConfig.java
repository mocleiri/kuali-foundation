...
public class ScmProjectConfig {
	...
	public List<DirRequest> projectScmConfigDirRequests() {
		...
		List<ProjectId> identifiers = ProjectUtils.getIdentifiers(projectIds);
		...
		for (ProjectId identifier : identifiers) {
	...
	protected DirRequest getDirRequest(ProjectId identifier, File stagingDir, File relativeDir, List<String> includes, List<String> excludes) {
