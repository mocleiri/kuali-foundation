...
import org.kuali.common.util.maven.spring.MavenAnnotationConstants;
...
public abstract class MavenConstants {
	...
	@Deprecated
	public static final String SPRING_PROFILE_NAME = MavenAnnotationConstants.MAVEN_PROFILE;

	@Deprecated
	public static final String NEGATED_SPRING_PROFILE_NAME = MavenAnnotationConstants.MAVEN_PROFILE_NEGATED;
