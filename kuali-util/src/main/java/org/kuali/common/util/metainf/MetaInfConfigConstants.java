...
public class MetaInfConfigConstants {
	...
	public static final String SQL_CONTEXT_ID = Str.getId(METAINF, SQL);
	public static final String SQL_BUILD_CONTEXT_ID = Str.getId(SQL_CONTEXT_ID, ConfigConstants.BUILD);
	...
	public static final String MPX_CONTEXT_ID = Str.getId(METAINF, MPX);
	public static final String MPX_BUILD_CONTEXT_ID = Str.getId(MPX_CONTEXT_ID, ConfigConstants.BUILD);
