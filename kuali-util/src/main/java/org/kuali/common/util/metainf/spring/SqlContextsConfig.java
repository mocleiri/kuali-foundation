...
public class SqlContextsConfig implements MetaInfContextsConfig {
	...
	private static final String RELATIVE_KEY = MetaInfCommonConfig.PROPERTY_PREFIX + ".sql.relative";
	private static final String PROPERTY_PREFIX = MetaInfCommonConfig.FEATURE_ID.getFeatureId();
	...
	public List<MetaInfContext> metaInfContexts() {
		...
		contexts.add(getMetaInfContext(SCHEMA_INCLUDES_KEY, MetaInfCommonConfig.SCHEMA_FILENAME));
		contexts.add(getMetaInfContext(DATA_INCLUDES_KEY, MetaInfCommonConfig.DATA_FILENAME));
		contexts.add(getMetaInfContext(CONSTRAINTS_INCLUDES_KEY, MetaInfCommonConfig.CONSTRAINTS_FILENAME));
		contexts.add(getMetaInfContext(OTHER_INCLUDES_KEY, MetaInfCommonConfig.OTHER_FILENAME));
		return contexts;
	}
