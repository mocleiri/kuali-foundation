...
public class DiffScmDirsExecutable implements Executable {

	private static final Logger logger = LoggerFactory.getLogger(DiffScmDirsExecutable.class);
	...
	public void execute() {
		...
		this.diff = FileSystemUtils.prepareScmDir(request, relativeDir, diffOnly);
	}
