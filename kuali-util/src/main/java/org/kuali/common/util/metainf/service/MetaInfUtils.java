...
public class MetaInfUtils {
    ...
    /**
     * <code>${project.build.outputDirectory}/META-INF/org/kuali/util/kuali-util/[qualifier]/[filename].resources</code>
     * where <code>[qualifier]</code> is optional
     */
    ...
    /**
     * <code>${project.build.outputDirectory}/META-INF/org/kuali/util/kuali-util/[qualifier]/[location]/[type]/[filename].resources</code>
     * where <code>[qualifier]</code>, <code>[location]</code>, and <type>[type]</type> are optional
     */
    ...
    /**
     * List of <code>classpath:META-INF/org/kuali/util/kuali-util/[filename].resources</code>
     * where <code>[filename]</code> can contain an Ant-style pattern
     */
    ...
    /**
     * List of <code>classpath:META-INF/org/kuali/util/kuali-util/[qualifier]/[group].resources</code>
     * where <code>[qualifier]</code> can contain an Ant-style pattern
     */
    ...
    /**
     * List of <code>classpath:META-INF/org/kuali/util/kuali-util/[qualifier]/[filename].resources</code>
     * where <code>[qualifier]</code> and <code>[filename]</code> can contain an Ant-style pattern
     */
    ...
    /**
     * List of <code>classpath:META-INF/org/kuali/util/kuali-util/[qualifier]/[location]/[type]/[filename].resources</code>
     * where <code>[qualifier]</code>, <code>[location]</code>, and <type>[type]</type> are optional
     * and <code>[qualifier]</code> and <code>[filename]</code> can contain an Ant-style pattern
     */
    public static List<String> getPatterenedClasspathResources(ProjectIdentifier project, Optional<String> qualifier, Optional<MetaInfDataLocation> location, Optional<MetaInfDataType> type, String filename) {
     ...
     * and <code>[qualifier]</code> and <code>[filename]</code> can contain an Ant-style pattern
     */
    public static List<String> getPatterenedClasspathResources(Project project, Optional<String> qualifier, Optional<MetaInfDataLocation> location, Optional<MetaInfDataType> type, String filename) {
        return getPatterenedClasspathResources(project.getGroupId(), project.getArtifactId(), qualifier, location, type, filename);
    }
    ...
    /**
     * List of <code>classpath:META-INF/org/kuali/util/kuali-util/[qualifier]/[filename].resources</code>
     * where <code>[qualifier]</code> is optional      * and <code>[qualifier]</code> and <code>[filename]</code> can contain an Ant-style pattern
     */
     ...
     * and <code>[qualifier]</code> and <code>[filename]</code> can contain an Ant-style pattern
     */
    public static List<String> getPatterenedClasspathResources(String groupId, String artifactId, Optional<String> qualifier, Optional<MetaInfDataLocation> location, Optional<MetaInfDataType> type, String filename) {
