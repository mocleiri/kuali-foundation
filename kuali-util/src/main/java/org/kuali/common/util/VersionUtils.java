...
public class VersionUtils {
	...
	/**
	 * Return true if <code>version</code> ends with <code>-SNAPSHOT</code> (case insensitive).
	 */
	public static final boolean isSnapshot(String version) {
		return StringUtils.endsWithIgnoreCase(version, MAVEN_SNAPSHOT_TOKEN);
	}
	...
	public static final String trimSnapshot(String version) {
		if (isSnapshot(version)) {
			int length = MAVEN_SNAPSHOT_TOKEN.length();
