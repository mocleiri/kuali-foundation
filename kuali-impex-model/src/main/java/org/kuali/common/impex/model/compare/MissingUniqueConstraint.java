...
public class MissingUniqueConstraint extends UniqueConstraintDifference {
    ...
    public MissingUniqueConstraint(Schema sourceSchema, Table sourceTable, Schema missingSchema, Table missingTable, UniqueConstraint u) {
        super(sourceSchema, sourceTable, u, missingSchema, missingTable, null);
