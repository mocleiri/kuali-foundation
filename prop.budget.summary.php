...
<section>
  <div class="sectionContents">
    ...
    <div class="container">
      ...
      </div><div class="docControls"> <a href="prop.questionnaire.php" class="btn"><i class="icon-chevron-left"></i> Back</a> <a href="#" class="btn">Save</a> <a href="prop.budget.paramaters.php" class="btn btn-inverse">Save and Continue <i class="icon-white icon-chevron-right"></i></a> </div>
    </div>
  </div>
