...
public class Index {
    ...
    /**
     * Creates a new instance with default characteristics (no name or parent table, small column list size allocation,
     * non-unique).
     */
    public Index() {
    ...
    /**
     * Creates a new instance for the list of columns composing an index. Otherwise performs as {@link #Index()}.
     * 
     * @param table
     *            The table this index is associated with.
     * @param indexColumns
     *            The list of {@link org.apache.torque.engine.database.model.Column} objects which make up this index.
     *            Cannot be empty.
    ...
    /**
     * Returns the list of names of the columns referenced by this index. Slightly over-allocates the list's buffer
     * (just in case more elements are going to be added, such as when a name is being generated). Feel free to modify
     * this list.
     * 
     * @return a list of column names
     */
    ...
    public String toString() {
        ...
        for (int i = 0; i < indexColumns.size(); i++) {
            result.append("  <index-column name=\"").append(indexColumns.get(i)).append("\"/>\n");
        }
        result.append(" </index>\n");
