...
public class EngineException extends NestableException {
    ...
    /**
     * Constructs a new <code>EngineException</code> with specified nested <code>Throwable</code>.
     * 
     * @param nested
    ...
    /**
     * Constructs a new <code>EngineException</code> with specified detail message and nested <code>Throwable</code>.
     * 
     * @param msg
     *            the error message.
     * @param nested
