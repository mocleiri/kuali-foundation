...
public class SqlExecMojo extends AbstractMojo {
	...
	/**
	 * Call {@link #setOrderFile(String)} with this value to sort in ascendant
	 * order the sql files.
	 */
	public static final String FILE_SORTING_ASC = "ascending";

	/**
	 * Call {@link #setOrderFile(String)} with this value to sort in descendant
	 * order the sql files.
	 */
	 ...
	 * are <code>ascending</code> and <code>descending</code>. Any other value
	 * means that no sorting will be performed.
	 * 
	 * @since 1.1
