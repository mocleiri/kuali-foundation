...
import org.kuali.common.impex.service.schema.impl.mysql.MySqlForeignKeySqlProducer;

import static junit.framework.Assert.assertEquals;

public class TestMySqlForeignKeySqlProducer {
    ...
    public void testGetForeignKeySql() {
        ...
        MySqlForeignKeySqlProducer producer = new MySqlForeignKeySqlProducer();
