...
public class KualiSiteMojo extends AbstractMojo implements SiteContext {
     ...
     * build/publication process identifies a project as being a top level Kuali project if it has one of these POM's as
     * a parent. Version is ignored, only groupId and artifactId are relevant.
     *
     * @parameter
     */
