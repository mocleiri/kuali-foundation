...
public class BuilderComposer {
	...
	public String composeSkeleton() {
		return StringUtils.join(new String[] { "public static class Builder{", "}" }, "\n");
	}
	...
	public String composeWithMethod(Field field) {
		Validate.notNull(field, "field may not be null");
		return StringUtils.join(new String[] { composeWithMethodFirstLine(field), "  this." + field.getName() + " = " + field.getName() + ";", "  return this;", "}" }, "\n");
	}
	...
	public String composeValidateMethodFromExisting(ComposerRequest request, ValidateMethod originalValidateMethod) {
	...
	private String composeWithMethodSignature(String methodName, String fieldSignature, String fieldName) {
