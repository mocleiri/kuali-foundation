...
public enum PackageGroups {
	...
	private PackageGroups(List<String> names) {
		this.names = names;
	}
	...
	private static List<String> of(PackageGroups packages, String... names) {
		return of(ImmutableList.of(packages), names);
	}

	private static List<String> of(List<PackageGroups> packages, String... names) {
		List<String> newList = new ArrayList<String>();
		for (PackageGroups pkg : packages) {
	...
	private static List<PackageGroups> of(PackageGroups... packages) {
