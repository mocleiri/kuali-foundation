...
public class FileCacheFactory {
	...
	public static <T, V> PersistentCacheLoader<String, String> createHttpUrlCacher() {
		return createHttpUrlCacher(HttpContext.create());
	}

	public static <T, V> PersistentCacheLoader<String, String> createHttpUrlCacher(HttpContext context) {
		return createHttpUrlCacher(context, UrlToFileFunction.create().getBasedir(), context.getEncoding());
	}

	public static <T, V> PersistentCacheLoader<String, String> createHttpUrlCacher(HttpContext context, File basedir) {
		return createHttpUrlCacher(context, basedir, context.getEncoding());
	}

	public static <T, V> PersistentCacheLoader<String, String> createHttpUrlCacher(HttpContext context, File basedir, String encoding) {
		...
		PersistentCacheLoader.Builder<String, String> builder = new PersistentCacheLoader.Builder<String, String>();
