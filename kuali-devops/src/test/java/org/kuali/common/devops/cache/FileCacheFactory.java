...
public class FileCacheFactory {
	...
	public static <T, V> PersistentLoader<String, String> createHttpUrlCacher(HttpContext context) {
		return createHttpUrlCacher(context, UrlToFileFunction.create().getBasedir(), context.getEncoding());
	}

	public static <T, V> PersistentLoader<String, String> createHttpUrlCacher(HttpContext context, File basedir) {
		return createHttpUrlCacher(context, basedir, context.getEncoding());
	}

	public static <T, V> PersistentLoader<String, String> createHttpUrlCacher(HttpContext context, File basedir, String encoding) {
		...
		PersistentLoader.Builder<String, String> builder = new PersistentLoader.Builder<String, String>();
