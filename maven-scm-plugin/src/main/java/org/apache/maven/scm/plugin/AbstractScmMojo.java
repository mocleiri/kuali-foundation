...
public abstract class AbstractScmMojo extends AbstractMojo {
    ...
    /**
     * The url of tags base directory (used by svn protocol). It is not necessary to set it if you use the standard svn
    ...
    /**
     * Should distributed changes be pushed to the central repository? For many distributed SCMs like Git, a change like
     * a commit is only stored in your local copy of the repository. Pushing the change allows your to more easily share
     * it with other users.
     * 
