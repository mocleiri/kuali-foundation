...
public class ExtractionUtils {
     ...
     * Used as a convenience method to get the most relevant primary key information from the full data extracted for primary keys of a table
     *
     * @param primaryKeyData a Map assumed to be the result of calling extractPrimaryKeyColumns
     ...
     *
     * ** NOTE **
     * Unique constraints will be included in these indices, but not the primary key index for the table (if it has one)
     * ** NOTE **
     *
     * @param tableName Name of the table
     * @param schemaName Name of the schema
     * @param databaseMetaData Connection to the database metadata
