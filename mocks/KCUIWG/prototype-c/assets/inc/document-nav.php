<div id="ToC"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Navigate</a>
  <ul style="display: block;">
    <li class="submenu <?php if( ($page == 'basics') || (strpos($page, "basics-") !== false) ) { echo 'open'; } ?>"><a href="#"><i class="icon icon-basics"></i><span>Basics </span></a>
      <ul>
    ...
    <li class="submenu <?php if( ($page == 'personnel') || (strpos($page, "personnel-") !== false) ) { echo 'open'; } ?>"><a href="#"><i class="icon icon-personnel"></i><span>Key Personnel</span></a>
      <ul>
    ...
    <li class="submenu <?php if( ($page == 'attachments') || (strpos($page, "attachments-") !== false) ) { echo 'open'; } ?>"><a href="#"><i class="icon icon-attachments"></i><span>Attachments </span></a>
      <ul>
    ...
    <li <?php if( $page == 'questionnaire' ) { echo 'class="active"'; } ?>><a href="prop.questionnaire.php"><i class="icon icon-questionnaire"></i><span>Questionnaire</span></a></li>
    
   
   
   
    <li class="submenu <?php if( ($page == 'budget') || (strpos($page, "budget-") !== false) ) { echo 'open'; } ?>">
      <a href="#"><i class="icon icon-budget"></i><span>Budget <small style="margin-left: 8px;">(version 3)</small></span></a>
      <ul>
    ...
    <li class="submenu <?php if( ($page == 'instspecdata') || (strpos($page, "instspecdata-") !== false) ) { echo 'open'; } ?>">
      <a href="#"><i class="icon icon-institutiondata"></i><span>Institution Data</span></a>
      <ul>
    ...
    <!--<li><a href="prop.medusa.php"><i class="icon icon-medusa"></i><span>Medusa</span></a></li>--> 
     ...
     <li class="submenu <?php if( ($page == 'review') || (strpos($page, "review-") !== false) ) { echo 'open'; } ?>">
      <a href="#"><i class="icon icon-review"></i><span>Review &amp; Approve</span></a>
      <ul>
        <li <?php if( $page == 'review-summary' ) { echo 'class="active"'; } ?> ><a href="prop.review.summary.php"><span>Proposal Summary</span></a></li>
        <?PHP
		/*
        <li <?php if( $page == 'review-persons' ) { echo 'class="active"'; } ?> ><a href="prop.review.persons.php"><span>Key Persons</span></a></li>
        <li <?php if( $page == 'review-budget' ) { echo 'class="active"'; } ?> ><a href="prop.review.budget.php"><span>Budget Summary</span></a></li>
        <li <?php if( $page == 'review-attachments' ) { echo 'class="active"'; } ?> ><a href="prop.review.attachments.php"><span>Attachments</span></a></li>
        <li <?php if( $page == 'review-specialreview' ) { echo 'class="active"'; } ?> ><a href="prop.review.specialreview.php"><span>Special Review</span></a></li>
        <li <?php if( $page == 'review-print' ) { echo 'class="active"'; } ?> ><a href="prop.review.print.php"><span>Proposal Print</span></a></li>
        */
        ?>
        <li <?php if( $page == 'review-actions' ) { echo 'class="active"'; } ?> ><a href="prop.review.actions.php"><span>Proposal Actions</span></a></li>
      </ul>
    </li>
