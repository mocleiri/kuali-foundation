...
<section>
  <div class="sectionContents">
    ...
    <div class="container"> <?php require_once( 'assets/inc/document-header.php' ) ?>
          ...
          <div class=" formfields">
            ...
            <fieldset>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <a href="#" class="btn btn-mini btn-inverse">Add attachment</a>
                </div>
              </div>
            </fieldset>
      ...
      </div><div class="docControls"> <a href="prop.compliance.php" class="btn"><i class="icon-chevron-left"></i> Back</a> <a href="#" class="btn">Save</a> <a href="prop.attachments.personnel.php" class="btn btn-inverse">Save and Continue <i class="icon-white icon-chevron-right"></i></a> </div>
    </div>
  </div>
