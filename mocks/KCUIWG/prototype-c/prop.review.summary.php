            ...
            <table class="table table-striped table-bordered table-condensed" style="margin-top:-13px;">
              <thead>
                <tr>
                  ...
                  <th nowrap="" style="text-align:center">First Year<br><small style="font-weight:normal;">02/01/2013 – 12/31/2015</small></th>
                  <th nowrap="" style="text-align:center">Total<br><small style="font-weight:normal;">02/01/2013 – 01/31/2015</small></th>
                </tr>
              </thead>
              <tbody>
                <tr>
