...
<section>
  <div class="sectionContents">
    ...
    <div class="container">
      ...
      <div class="docControls"> <a href="prop.medusa.php" class="btn"><i class="icon-chevron-left"></i> Back</a> <a href="#" class="btn btn-success">Print</a> <a href="prop.review.actions.php" class="btn btn-inverse"><!--Save and -->Continue <i class="icon-white icon-chevron-right"></i></a> </div>
    </div>
  </div>
