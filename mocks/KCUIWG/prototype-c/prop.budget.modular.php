...
<section>
  <div class="sectionContents">
    ...
    <div class="container"> <?php require_once( 'assets/inc/document-header.php' ) ?>
      ...
      </div><div class="docControls"> <a href="prop.budget.distincome.php" class="btn"><i class="icon-chevron-left"></i> Back</a> <a href="#" class="btn">Save</a> <a href="prop.budget.actions.php" class="btn btn-inverse">Save and Continue <i class="icon-white icon-chevron-right"></i></a> </div>
    </div>
  </div>
