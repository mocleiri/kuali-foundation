...
<section>
  <div class="sectionContents">
    ...
    <div class="container"> <?php require_once( 'assets/inc/document-header.php' ) ?>
        ...
        <div class="span2 vertNav">
          ...
          <div class=" formfields">
            ...
            <fieldset>
              ...
              <div class="control-group">
                <!-- Text input-->
                <label class="control-label" for="input01">Note Text</label>
                <div class="controls">
                  <input type="text" class="input-xlarge">
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls"><a href="#" class="btn btn-mini btn-inverse">Save note</a></div>
              </div>
            </fieldset>
            <div class="boxSubheader expandControl closed ">
              <h4> this_file.pdf</h4>
            </div>
            <div class="expandTarget clearfix " style="display:none">
      ...
      </div><div class="docControls"> <a href="prop.attachments.abstracts.php" class="btn"><i class="icon-chevron-left"></i> Back</a> <a href="#" class="btn">Save</a> <a href="prop.questionnaire.php" class="btn btn-inverse">Save and Continue <i class="icon-white icon-chevron-right"></i></a> </div>
    </div>
  </div>
