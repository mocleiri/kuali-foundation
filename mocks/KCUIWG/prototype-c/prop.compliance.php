...
<section>
  <div class="sectionContents">
    ...
    <div class="container"> <?php require_once( 'assets/inc/document-header.php' ) ?>
                  ...
                  <tbody>
                    <tr id="addrow01" style="display:none">
                      ...
                      <td><div class="date" data-date="03-06-2013" data-date-format="mm-dd-yyyy">
                        <div class="input-append"><input type="text" id="" name="" class="input-mini"><span class="add-on"><i class="icon-calendar"></i></span></div>
                      </div></td>
                      <td><div class="date" data-date="03-06-2013" data-date-format="mm-dd-yyyy">
                        <div class="input-append"><input type="text" id="" name="" class="input-mini"><span class="add-on"><i class="icon-calendar"></i></span></div>
                      </div></td>
                      ...
                      <td><a href="#" class="btn btn-mini btn-inverse">Save</a>
      ...
      </div><div class="docControls"> <a href="prop.keypersonnel.creditfa.php" class="btn"><i class="icon-chevron-left"></i> Back</a> <a href="#" class="btn">Save</a> <a href="prop.attachments.proposal.php" class="btn btn-inverse">Save and Continue <i class="icon-white icon-chevron-right"></i></a> </div>
    </div>
  </div>
