    ...
    <div class="row-fluid">
      <div class="span12 content">
        ...
        <div style=" padd12px; text-align:center">
          <a href="prop.attachments.personnel.php" class="btn"><i class="icon-chevron-left"></i> back</a>
          <a href="#" class="btn">save</a>
          <a href="prop.attachments.abstracts.php" class="btn btn-inverse">save and continue<i class="icon-white icon-chevron-right"></i></a>
        </div>
      </div>
