    ...
    <div class="row-fluid">
      <div class="span12 content">
        ...
        <div style=" padd12px; text-align:center">
          <a href="prop.access.php" class="btn"><i class="icon-chevron-left"></i> Back</a>
          <a href="#" class="btn">Save</a>
          <a href="prop.attachments.proposal.php" class="btn btn-inverse">Save and Continue <i class="icon-white icon-chevron-right"></i></a>
        </div>
