...
<div class="span12 content"> <h3>Internal Attachments</h3>
...
<div class="docControls"> <a href="prop.attachments.personnel.php" class="btn"><i class="icon-chevron-left"></i> Back</a> <a href="#" class="btn">Save</a> <a href="prop.attachments.abstracts.php" class="btn btn-inverse">Save and Continue <i class="icon-white icon-chevron-right"></i></a> </div>
