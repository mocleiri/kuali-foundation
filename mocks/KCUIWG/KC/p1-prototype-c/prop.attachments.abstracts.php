...
<section>
  <div class="sectionContents">
    ...
    <div class="container"> <?php require_once( 'assets/inc/document-header.php' ) ?>
            ...
            <form  class="form-horizontal" method="get" action="">
              <fieldset style="">
                <div class="boxContent ">
                  ...
                  <div class="boxSubheader expandControl closed ">
                    <h4> this_file.pdf</h4>
                  </div> <div class="expandTarget clearfix" style="display:none">
                    <dl class="table-display" style="margin-top:-13px;">
                      <dt>File </dt>
                      <dd> this_file.pdf </dd>
                      <dt>Attachment Type:</dt>
      ...
      </div><div class="docControls"> <a href="prop.attachments.internal.php" class="btn"><i class="icon-chevron-left"></i> Back</a> <a href="#" class="btn">Save</a> <a href="prop.attachments.notes.php" class="btn btn-inverse">Save and Continue <i class="icon-white icon-chevron-right"></i></a> </div>
    </div>
  </div>
