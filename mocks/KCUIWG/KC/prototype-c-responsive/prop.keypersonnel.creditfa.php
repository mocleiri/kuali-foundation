...
<section>
  <div class="sectionContents col2">
    ...
    <div class="container leftnav">
      ...
      <div class="docControls"> <a href="prop.keypersonnel.creditintel.php" class="btn"><i class="icon-chevron-left"></i> Back</a> <a href="#" class="btn">Save</a> <a href="prop.compliance.php" class="btn btn-inverse">Save and Continue <i class="icon-white icon-chevron-right"></i></a> </div>
    </div>
  </div>
