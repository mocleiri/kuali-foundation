...
<div class="span12 content"> <h3>Institution Data 2</h3>
...
<div class="docControls"> <a href="prop.instspecdata.1.php" class="btn"><i class="icon-chevron-left"></i> Back</a> <a href="#" class="btn">Save</a> <a href="prop.instspecdata.3.php" class="btn btn-inverse">Save and Continue <i class="icon-white icon-chevron-right"></i></a> </div>
