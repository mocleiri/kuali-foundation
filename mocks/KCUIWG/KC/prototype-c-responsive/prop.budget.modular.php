...
<div class="span12 content"> <div class="box">
            <div class="boxHeader">
              <h3> Budget: Modular</h3>
              <h4> Modular Budget Overview (Project)</h4>
            </div>
...
<div class="docControls"> <a href="prop.budget.distincome.php" class="btn"><i class="icon-chevron-left"></i> Back</a> <a href="#" class="btn">Save</a> <a href="prop.budget.actions.php" class="btn btn-inverse">Save and Continue <i class="icon-white icon-chevron-right"></i></a> </div>
