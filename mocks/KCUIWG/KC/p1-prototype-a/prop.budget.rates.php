    ...
    <div class="row-fluid">
      <div class="span12 content">
        <ul class="breadcrumb"> <li class="active"><a href="prop.budget.php">Budget Home</a> <span class="divider">/</span></li>
          ...
          <li class=" active"><a href="prop.budget.rates.php">Rates</a></li>
        ...
        <div class="box"> <div class="boxHeader expandControl">
          ...
          <div class="boxContent expandTarget" style=" display:block" > <table class="table table-striped table-bordered table-condensed">
                <thead>
                  <tr>
                    <th>Label</th>
                    <th>Label</th>
        ...
        <div style=" padd12px; text-align:center">
          <a href="prop.budget.paramaters.php" class="btn"><i class="icon-chevron-left"></i> Back</a>
          <a href="#" class="btn">Save</a>
          <a href="prop.budget.personnel.php" class="btn btn-inverse">Save and Continue <i class="icon-white icon-chevron-right"></i></a>
        </div>
      </div>
    </div>
  </form>
