  ...
  <div class="sectionContents">
    ...
    <div class="container"> <?php require_once( 'assets/inc/document-header.php' ) ?>
      <div class="row-fluid column-navleft">
        ...
        </div> <div class="span10"><!--<div class="btn-group" style="margin-bottom:20px">
            ...
            <div class="boxSubheader">
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="#myModal" role="button" data-toggle="modal" class="btn btn-danger pull-right">Delete</a></td>
                </tr>
                <tr>
                  <td>Tatum, Art</td>
      ...
      </div><div class="docControls"> <a href="prop.budget.rates.php" class="btn"><i class="icon-chevron-left"></i> Back</a> <a href="#" class="btn">Save</a> <a href="prop.budget.nonpersonnel.php" class="btn btn-inverse">Save and Continue <i class="icon-white icon-chevron-right"></i></a> </div>
    </div>
  </div>
