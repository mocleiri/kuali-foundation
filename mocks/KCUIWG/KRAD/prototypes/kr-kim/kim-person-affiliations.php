			...
			<nav id="Uif-Navigation" style="position:absolute; display:none">
				<div id="LabsProposal-Menu" class="uif-menuNavigationGroup">
					...
					<ul class="nav nav-list">
						...
						<li class="active"> <a href="kim-person-affiliations.php"id="u79gei9" class="uif-navigationActionLink" ><span class="icon-puzzle"></span><span class="uif-innerText">Affiliations</span></a> </li>
			...
			<main id="LabsProposal-Page" class="uif-page uif-hasLeftNav" data-server_messages="false" data-role="Page" data-parent="LabsProposal" style="margin-left: 235px;">
				<header class="clearfix uif-header-contentWrapper pull-left">
					<div id="u148pgf0" class="uif-pageHeader clearfix" data-header_for="LabsProposal-Page">
						<h2 class="uif-headerText"> <span class="uif-headerText-span"> Affiliations </span> </h2>
					</div>
				</header>
				...
				<table id="u569ish_line0" class="table table-condensed" role="presentation">
							<tbody>
								<tr>
									...
									<th class="uif-gridLayoutCell">Campus Code</th>
								...
								<tr>
									<td scope="row"><a href="#"><span class="icon-chevron-right" style="font-size:10px"></span> Staff</a></td>
									<td class="">BL-Bloomington</td>
									<td class="">&nbsp;</td>
									<td class=""><a href="#" class="btn btn-xs btn-default">Edit</a> <a href="#" class="btn btn-xs btn-default">Delete</a></td>
								</tr>
								<tr>
									<td scope="row"><a href="#"><span class="icon-chevron-right" style="font-size:10px"></span> Faculty</a></td>
									<td class="">BL-Bloomington</td>
									<td class="">&nbsp;</td>
									<td class=""><a href="#" class="btn btn-xs btn-default">Edit</a> <a href="#" class="btn btn-xs btn-default">Delete</a></td>
								</tr>
