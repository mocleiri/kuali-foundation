			...
			<nav id="Uif-Navigation" style="position:absolute; display:none">
				<div id="LabsProposal-Menu" class="uif-menuNavigationGroup">
					...
					<ul class="nav nav-list">
						...
						<li class="active"> <a href="kim-person-contactinfo.php" id="u79gei9" class="uif-navigationActionLink" ><span class="icon-list-alt"></span><span class="uif-innerText">Contact Info</span></a> </li>
