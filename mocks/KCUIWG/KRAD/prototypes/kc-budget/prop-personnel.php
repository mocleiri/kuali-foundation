...
<!-- VIEW HEADER -->
<?php include('includes/uif-viewHeader-proposal.php') ?>
<!-- // VIEW HEADER -->
<!-- VIEW CONTENT -->
...
<!-- MODAL ADD PERSONNEL -->
<?php include ('includes/modal-prop-add-personnel.php') ?>
<?php include ('includes/modal-prop-add-personnel1.php') ?>
<?php include ('includes/modal-prop-add-personnel1-results.php') ?>
<?php include ('includes/modal-prop-add-personnel1-results-tbn.php') ?>
<!-- MODAL budget complete buttons -->
<?php include ('includes/modal-budget-complete.php') ?>
