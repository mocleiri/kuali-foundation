...
">
            ...
            <tr class="uif-new-row">
                <td class="not-editable"><span class="uif-text-medium">Jason Bourne</span> <small class="text-muted">Boston University<br />Graduate Research Assistant</small></td>
                <td><div id="u11k8c4j2" class="uif-inputField" data-parent="u14jg6xp" data-role="InputField" data-label="Award ID">
                        <div class="input-group">
                            <input id="u11k8c4j_control2" type="text" name="u11k8c4j_control" value="" size="" class="form-control input-sm uif-textControl has-helper" data-role="Control" data-control_for="u11k8c4j" style="
    width: 80px;
...
">
            ...
            <tr class="uif-new-row">
                <td class="not-editable"><span class="uif-text-medium">Maynard J. Keenan</span> <small class="text-muted">Tool Inc.<br />Key Person</small></td>
                <td><div id="u11k8c4j2" class="uif-inputField" data-parent="u14jg6xp" data-role="InputField" data-label="Award ID">
                        <div class="input-group">
                            <input id="u11k8c4j_control2" type="text" name="u11k8c4j_control" value="" size="" class="form-control input-sm uif-textControl has-helper" data-role="Control" data-control_for="u11k8c4j" style="
    width: 80px;
...
">
            ...
            <tr class="uif-new-row">
                <td class="not-editable"><span class="uif-text-medium">TBN</span> <small class="text-muted">MIT<br />Graduate Assistant</small></td>
                <td><div id="u11k8c4j2" class="uif-inputField" data-parent="u14jg6xp" data-role="InputField" data-label="Award ID">
                        <div class="input-group">
                            <input id="u11k8c4j_control2" type="text" name="u11k8c4j_control" value="" size="" class="form-control input-sm uif-textControl has-helper" data-role="Control" data-control_for="u11k8c4j" style="
    width: 80px;
...
">
            ...
            <tr>
                <td colspan="7">
                    <a class="btn btn-default pull-right" href="#" data-toggle="modal" data-target="#modal-add-personnel">Add more people to this budget</a>
                </td>
            </tr>
            </tfoot>
        </table>
