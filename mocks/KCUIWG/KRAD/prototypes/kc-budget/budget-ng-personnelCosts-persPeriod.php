...
<?php include ('includes/styles.php') ?>
	<style>/* setting the width to align with inputs */
											...
											<div class="dropdown-menu dropdown-menu-large row" style="position: absolute;left: -746px;top: 26px;width: 858px;padding:15px; background:#fcf8e3;">
												...
												<div class="row">
													<div class="col-md-12" style="position:relative; display:none;">
														<div style="position:absolute;right:10px;width:250px ; height:250px;top:1px; margin-bottom:20px;">
															<label style="clear:both; width:100%;">Description: <br>
															<textarea class="form-control" rows="3" style="width:250px ; height:197px;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</textarea>
															</label> 
														</div>
													</div>
													<div class="form-horizontal" role="form">
														<div class="form-group ">
															<label for="role-1" class="col-sm-3 control-label">Role:</label> 
															<div class="col-sm-2">
																<select id="role-1" class="form-control input-sm">
															...
															<label for="inputPassword3" class="col-sm-3 control-label">Period Type:</label> 
															<div class="col-sm-2">
														...
														<div class="form-group">
															<label for="inputPassword3" class="col-sm-3 control-label">Effort:</label> 
															<div class="col-sm-2">
																<div class="input-group">
																	<input id="rate-1" class="form-control text-right" type="text" value="100">
																	<span class="input-group-addon">%</span> 
																</div>
															</div>
															<label for="inputPassword3" class="col-sm-3 control-label">Charged:</label> 
															<div class="col-sm-2">
																<div class="input-group">
																	<input id="rate-2" class="form-control text-right" type="text" value="50">
																	<span class="input-group-addon">%</span> 
																</div>
															</div>
														</div>
														<div class="form-group">
															<label for="inputPassword3" class="col-sm-3 control-label">Requested Salary:</label> 
															<div class="col-sm-2">
																<div class="input-group">
																	<span class="input-group-addon">$</span> 
																	<input class="form-control text-right" type="number" value="142,525.00">
																</div>
															</div>
															<label for="inputPassword3" class="col-sm-3 control-label">Calculated Fringe:</label> 
															<div class="col-sm-2">
																<div class="input-group">
																	<span class="input-group-addon">$</span> 
																	<input class="form-control text-right" type="number" value=".00">
																</div>
															</div>
														</div>
														<div class="form-group">
															<label for="inputPassword3" class="col-sm-3 control-label">Cost Sharing Amount:</label> 
															<div class="col-sm-2">
																<div class="input-group">
																	<span class="input-group-addon">$</span> 
																	<input class="form-control text-right" type="number" value=".00">
															...
															<label for="inputPassword3" class="col-sm-3 control-label">Cost Sharing Percent:</label> 
															<div class="col-sm-2">
																<div class="input-group">
																	<input class="form-control text-right" type="number" value=".00">
																	<span class="input-group-addon">%</span> 
														...
														<div class="form-group">
															<label for="input3" class="col-sm-3 control-label">Unrecovered F&amp;A:</label> 
															<div class="col-sm-2">
																<div class="input-group">
																	<span class="input-group-addon">$</span> 
																	<input id="input3" class="form-control text-right" type="number" value="142,525.00">
																</div>
															</div>
															<label for="inputPassword3" class="col-sm-3 control-label">Person Months:</label> 
															<div class="col-sm-4">
																<input class="form-control text-right" type="number" value="1.30" style="width:128px;">
															</div>
														</div>
														<div class="col-md-12">
															<label for="inputPassword3" class="col-sm-3 control-label">Description: <br>
															<textarea class="form-control" style=" width:480px; margin:-30px 0 20px 200px ;height:70px;;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</textarea>
															</label> 
														</div>
														<hr>
														<div class="form-group">
															<div class="col-sm-offset-5 col-sm-4">
																<a href="#" class="btn btn-default btn-sm">Cancel</a> <a href="#" class="btn btn-primary btn-sm">Save Changes</a> 
															</div>
														</div>
													</div>
												</div>
...
<!-- VIEW FOOTER --> <div id="" class="uif-footer clearfix uif-stickyFooter uif-stickyButtonFooter" data-sticky_footer="true" data-parent="LabsProposal" style="position:fixed; left: 0; bottom: 0px;"> <div class="global-actions"> <a id="" class="btn btn-default uif-secondaryActionButton uif-boxLayoutHorizontalItem">Save </a> <a id="" class="btn btn-default uif-secondaryActionButton uif-boxLayoutHorizontalItem">Reload </a> <a id="ufuknl9" class="btn btn-default uif-secondaryActionButton uif-boxLayoutHorizontalItem">Complete Budget </a> </div>
            ...
            <div class="global-navigate"><a href="budget-ng-personnelCosts-projPersonnel2.php" id="ufuknm4" class="btn btn-default uif-primaryActionButton uif-boxLayoutHorizontalItem"><span class="icon-chevron-left"></span> Back</a>
            <a href="budget-ng-non-personnel.php" id="ufuknm4" class="btn btn-primary uif-primaryActionButton uif-boxLayoutHorizontalItem">Continue <span class="icon-chevron-right"></span></a></div>
        </div>
