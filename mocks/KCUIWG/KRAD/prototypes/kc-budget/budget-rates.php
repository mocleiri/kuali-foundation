...
<form id="kualiForm" action="../kr-krad/uicomponents" method="post" accept-charset="UTF-8">
    ...
    <div id="LabsProposal" class="clearfix uif-formView" data-role="View" style="margin-top: 75px;"> 
        ...
        <div id="Uif-ViewContentWrapper" class="uif-viewContentWrapper container"> 
            ...
            <main id="LabsProposal-Page" class="uif-page uif-hasLeftNav" data-server_messages="false" data-role="Page" data-parent="LabsProposal" style="margin-left: 235px;">
                ...
                <p  id="u1iaxrzf" class="uif-message uif-boxLayoutVerticalItem clearfix"> Verify the default rates set by your institution. You can override them if necessary by clicking the "edit" icon to the right of each row.</p><br>
                ...
                <div class="pull-right">    <a href="#" class="btn btn-xs btn-default">Reset to Institutional Defaults</a>   <a href="#" class="btn btn-xs btn-default">Refresh Rates</a></div><br><br>
 ...
 Field 4: : activate to sort column ascending"> <label id="u9u34v6" class="uif-label"> </label></th>
                ...
                </section><section id="u1qq592w" class="uif-disclosure uif-boxLayoutVerticalItem clearfix" data-parent="Demo-Disclosure-Example1">
                    <header id="u1l3ufy3" class="uif-sectionHeader" data-header_for="u1qq592w">
