        ...
        <td colspan="5" >Totals</td>
                    ...
                    <tr>
                        ...
                        <td class="uif-center-aligned uif-column-special">
                            <button class="btn btn-default btn-xs" disabled>Generate Periods <br> from Period 1</button>
                        </td>
                        <td colspan="5"></td>
                    </tr>
                    </tfoot>
