...
<form id="kualiForm" action="../kr-krad/uicomponents" method="post" accept-charset="UTF-8">
    ...
    <div id="LabsProposal" class="clearfix uif-formView" data-role="View" style="margin-top: 75px;"> 
        ...
        <div id="Uif-ViewContentWrapper" class="uif-viewContentWrapper container"> 
            ...
            <main id="LabsProposal-Page" class="uif-page uif-hasLeftNav" data-server_messages="false" data-role="Page" data-parent="LabsProposal" style="margin-left: 235px;">
                ...
                <div class="uif-boxLayoutVerticalItem clearfix">
                    <p><b>Enter the summary details for Period 2:</b></p>
                </div>
                <div class="uif-cssGridGroup uif-boxLayoutVerticalItem clearfix">
                    <div class="row">
                        <div class="well">
                            ...
                            <div class="row">
                                <div class="col-md-2">                                           
                                    <a class="btn btn-default btn-xs" href="#">Auto-increment</a>                                   
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-default btn-xs" href="#">Copy from previous period</a>  
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="uif-footer clearfix">
            <a class="btn btn-default" href="budget-gm-sum-period-1.php"><span class="icon-chevron-left"></span> Back</a>
            <a class="btn btn-primary" href="budget-gm-sum-modular.php">Continue</a>
        </div> 
