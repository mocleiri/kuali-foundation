            ...
            <main id="LabsProposal-Page" class="uif-page uif-hasLeftNav" data-server_messages="false" data-role="Page" data-parent="LabsProposal" style="margin-left: 235px;">
                <header class="clearfix uif-header-contentWrapper">
                    <div class="uif-pageHeader clearfix">
                        <h2 class="uif-headerText">Budget Notes
...
<!-- carousel -->
        <div id="divCarousel" class="infiniteCarousel">
            <div class="carouselContainer">
                <ul>
                    <li>1. <a href="#" >Budget Summary</a></li>
                    <li>2. <a href="#" >Periods &amp; Totals</a></li>
                    <li>3. <a href="#" >Rates </a></li>
                    <li>4. <a href="#" >Personnel Costs Project Personnel</a></li>
...
<!-- // carousel --> <div class="row">
                        ...
                        <div class="uif-boxLayoutVerticalItem clearfix">
                            <p><b>Review the notes particular to this budget version.</b></p>
                        </div>
                    </div>
                </header>
