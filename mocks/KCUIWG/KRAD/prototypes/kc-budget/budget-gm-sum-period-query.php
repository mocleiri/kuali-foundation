...
<form id="kualiForm" action="../kr-krad/uicomponents" method="post" accept-charset="UTF-8">
    ...
    <div id="LabsProposal" class="clearfix uif-formView" data-role="View" style="margin-top: 75px;"> 
                    ...
                    <div class="row">
                        <div class="well">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">                                          
                                    <input type="text" class="form-control uif-dateControl hasDatepicker" placeholder="mm/dd/yyyy">
                                </div>
                                <div class="col-md-2">                                 
                                    <input type="text" class="form-control uif-dateControl hasDatepicker" placeholder="mm/dd/yyyy">
                                </div>
        ...
        <div class="uif-footer clearfix">
            <a class="btn btn-default" href="budget-gm-start.php"><span class="icon-chevron-left"></span> Back</a>
