					...
					<form action="#" method="post" class="form-horizontal">
						<fieldset>
							...
							<div class="form-group clearfix">
								...
								<div class="col-lg-5">
									<select name="notice_of_opp" id="notice_of_opp" class="form-control input-sm col-lg-8">
							...
							<div class="form-group clearfix">
								...
								<div class="col-lg-5">
									<select name="sponsor_deadline_type" id="sponsor_deadline_type" class="form-control input-sm col-lg-8">
										<option value="">select</option>
							...
							<div class="form-group clearfix">
								...
								<div class="col-lg-5">
									<select name="nsf_science_code" id="nsf_science_code" class="form-control input-sm col-lg-8">
										<option value="">select</option>
										<option value="P">Postmark</option>
										<option value="R">Receipt</option>
										<option value="T">Target</option>
