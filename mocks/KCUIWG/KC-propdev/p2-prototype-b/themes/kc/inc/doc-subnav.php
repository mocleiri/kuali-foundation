<div class="uif-navigation">
	<ul>
		<li <?php if ($section == "basics") { echo 'class="expanded"'; } ?>> <a href="#"><span aria-hidden="true" class="icon-file-alt"></span> Basics</a>
			<ul>
		...
		<li <?php if ($section == "keypersonnel") { echo 'class="expanded"'; } ?>><a href="#"><span aria-hidden="true" class="icon-user"></span> Key Pesonnel</a>
			<ul>
		...
		<li <?php if ($page == "compliance") { echo 'class="active"'; } ?>><a href="prop.compliance.php"><span aria-hidden="true" class="icon-ok"></span> Compliance</a></li>
		<li <?php if ($section == "attachments") { echo 'class="expanded"'; } ?>><a href="#"><span aria-hidden="true" class="icon-paper-clip"></span> Attachments</a>
			<ul>
		...
		<li <?php if ($page == "questions") { echo 'class="active"'; } ?>><a href="prop.questionnaire.php"><span aria-hidden="true" class="icon-question"></span> Questionnaire</a></li>
		<li <?php if ($section == "budget") { echo 'class="expanded"'; } ?>><a href="#"><span aria-hidden="true" class="icon-money"></span> Budget</a>
			<ul>
		...
		<li <?php if ($section == "instdata") { echo 'class="expanded"'; } ?>><a href="#"><span aria-hidden="true" class="icon-bell"></span> Institution Data</a>
			<ul>
		...
		<li <?php if ($page == "prop-summary") { echo 'class="active"'; } ?>><a href="prop.summary.php"><span aria-hidden="true" class="icon-signout"></span> Summary/Submit</a></li>
	</ul>
</div>