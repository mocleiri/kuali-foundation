    ...
    <?php require_once( 'themes/kc/inc/uif-documentFunctions.php' ); ?><div class="container-fluid">
        ...
        <div id="my-tab-content" class="tab-content">
          ...
          <div class="tab-pane " id="tab2">
            ...
            <div class="well well-small"> <a href="#" class="btn btn-default btn-sm" onclick="message()" value="Show alert box"> change organization... </a> </div>
            <table  class="table table-condensed">
              <tbody>
                <tr>
                  <th style="width:30%">Organization</th>
            ...
            <div class="panel-group" id="accordion1">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse1"> Clinical Trial Location </a> </h4>
                </div>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse2"> Research Location </a> </h4>
                </div>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse3"> Field Study Location </a> </h4>
                </div>
          ...
          <div class="tab-pane " id="tab4">
            ...
            <div class="well well-small"> <a href="#" class="btn btn-default btn-sm" onclick="message()" value="Show alert box"> add organization... </a> </div>
            <div class="panel-group" id="accordion2">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse4"> Communications Power </a> </h4>
                </div>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse5"> Cleveland Clinic Organization </a> </h4>
                </div>
