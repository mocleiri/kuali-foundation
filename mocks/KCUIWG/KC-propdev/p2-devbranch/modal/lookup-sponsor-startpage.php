...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="container"><p>Enter any known search criteria:</p>
    ...
    <div class="modal-footer"> <a href="lookup-sponsor-startpage-results.php" class="btn btn-primary">Search</a> <a href="#" class="btn btn-link fancy-close">Cancel</a></div>
  </div>
</div>
