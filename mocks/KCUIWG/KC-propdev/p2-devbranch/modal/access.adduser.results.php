...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <table class="table table-condensed table-hover table-smaller-text" id="example">
      ...
      <tbody>
        <tr>
          <td><a class=" btn btn-primary btn-xs" href="access.added.php" >Select</a></td>
    ...
    <div class="modal-footer"> <a class="btn btn-primary" href="access.adduser.php">Refine Search</a> <a href="access.php" class="btn btn-link">Cancel</a> </div>
