  ...
  <div id="Uif-ViewContentWrapper" class="uif-viewContentWrapper">
    <div class="container" style="">
      ...
      <div id="Uif-PageContentWrapper" class="uif-pageContentWrapper"> <!-- Main content goes here -->
					...
					<form action="#" method="post" class="form-horizontal">
						<fieldset>
							...
							<div class="form-group clearfix">
								...
								<div class="col-md-5">
									<textarea name="details" id="details" class="form-control input-sm col-md-8"></textarea>
								</div>
							</div>
						</fieldset>
					</form>
				...
				<!-- // -->
        <div class="uif-stickyFooter uif-stickyButtonFooter"> <!-- Button row --> <div class="container btn-row-page-action"> <button  onclick="location.href='prop.attachments.internal.php'" class="btn btn-default">Back</button>
