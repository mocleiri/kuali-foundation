<div id="sidebar" class="uif-navigation" style="margin-left:-15px; ">
	...
	<ul class="nav nav-list">
		...
		<li <?php if ($page == "attachments") { echo 'class="active"'; } ?>><a href="themes/kc/js/batch-file-uploader/kc.attachments.2.html"><i class="icon-paper-clip"></i> <span>Attachments</span> </a></li>
