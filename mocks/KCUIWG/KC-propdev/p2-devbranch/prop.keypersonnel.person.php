    ...
    <div id="collapse<?php echo $id?>" class="panel-collapse collapse" style="height: auto;">
        <div class="panel-body">
            <ul class="nav nav-tabs" id="myTab">
                ...
                <li><a href="#p1_proposalPersonCertification<?php echo $id?>" data-toggle="tab">Certification<small class="text-muted"> (complete)</small></a></li>
            </ul>
            ...
            <div class="tab-pane" id="p1_proposalPersonCertification<?php echo $id?>">
                <h4>Proposal Certification</h4>Ward Cleaver has completed certification. <a href="prop.keypersonnel.certify.html" target="new">View certification document </a>
                </form>
            </div>
        </div>
    </div>
