...
<section id="main">
    ...
    <?php require_once( 'themes/kc/inc/uif-documentFunctions.php' ); ?>
		...
		<!-- Button row -->
		<div class="btn-row-page-action"> <button  onclick="location.href='prop.inst.2.php'" class="btn btn-default">Back</button>
<button class="btn btn-default">Save</button>
      <button  onclick="location.href='prop.summary.php'" class="btn btn-primary">Save and continue</button>
