  ...
  <span class="glyphicon glyphicon-calendar"></span>
							...
							<div class="form-group clearfix">
								...
								<div class="col-md-3 input-group">
									...
									<span class="input-group-btn">
										<button class="btn btn-default input-sm"><span class="glyphicon glyphicon-calendar"></span></button>
									</span>
								</div>
							</div>
							...
							<div class="form-group clearfix">
								...
								<div class="col-md-5 input-group">
									...
									<span class="input-group-btn">
										<button name="sponsor_code_search" id="sponsor_code_search" class="btn btn-default input-sm"><span class="glyphicon glyphicon-search"></span></button>
									</span>
								</div>
							</div>
