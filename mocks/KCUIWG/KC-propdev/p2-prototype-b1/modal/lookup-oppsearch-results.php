    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
             <table class="table table-condensed table-hover table-smaller-text" id="example">
                ...
                <tbody>
                    <tr>
                        <td><a class="btn btn-primary btn-xs select-opportunity" href="#" data-href="../prop.basics.oppsearch-search-done.php">Select</a></td>
                        <td >00.000</td>
                        <td>12/31/2013</td>
                        <td >12/31/2014</td>
                        <td >NEWRRFORM</td>
        ...
        <div class="modal-footer">
            <a href="lookup-oppsearch.php" class="btn btn-default btn-sm">Refine Search</a> <a href="#" class="btn btn-link btn-sm">Cancel</a>
        </div>
    </div>
</div>
<script>
