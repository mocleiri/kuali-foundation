        ...
        <div id="my-tab-content" class="tab-content">
          ...
          <div class="tab-pane " id="tab4">
                                ...
                                <div class="question-response">
                                    <div class="question-reponse-choices">
                                        <div class="choice">
                                            ...
                                            <select name="q10" id="q10" style="display: none;">
                                                ...
                                                <option value="150">150: Walter Reed Army Institute Research</option></select><button type="button" class="ui-multiselect ui-widget ui-state-default ui-corner-all" aria-haspopup="true" tabindex="0"><span class="ui-icon ui-icon-triangle-1-s"></span><span>101: Agency for International Development</span></button>
                                ...
                                <div class="question-response">
                                    <div class="question-reponse-choices">
                                        <div class="choice">
                                            ...
                                            <input type="text" name="q13" id="q13" class="form-control uif-dateControl hasDatepicker" placeholder="mm/dd/yyyy">
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
                                ...
                                <div class="question-response">
                                    <div class="question-reponse-choices">
                                        <div class="choice">
                                            ...
                                            <select name="q14" id="q14" style="display: none;">
                                                <option value="1">Program is not covered by E.O. 12372</option>
                                                <option value="2">Program not selected for 12372 review</option>
                                            </select><button type="button" class="ui-multiselect ui-widget ui-state-default ui-corner-all" aria-haspopup="true" tabindex="0"><span class="ui-icon ui-icon-triangle-1-s"></span><span>Program is not covered by E.O. 12372</span></button>
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <a class="accordion-toggle icon icon-caret-right opened" data-toggle="collapse" data-parent="#question_set_2" href="#question_set_2_content"></a>
                        <div class="col panel-title-container">
                ...
                <div id="question_set_2_content" class="panel-collapse in" style="height: auto;">
                    <div class="panel-body">
                        <div class="question-set">
                            <fieldset class="question">
                                <div class="question-title">
