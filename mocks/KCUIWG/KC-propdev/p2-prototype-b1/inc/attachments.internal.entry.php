  <div class="panel panel-default" id="attachmentsInternalEntry<?php echo $id?>">
    <div class="panel-heading">
      <div class="row">
        <a class="accordion-toggle icon icon-caret-right" style="display: block; float: left; text-align: center; margin: -10px 0 -10px 0; padding: 25px 10px; border-right: 1px solid #ccc; background: #f9f9f9;" data-toggle="collapse" data-parent="#accordion" href="#attachmentsInternalCollapse<?php echo $id?>" entryId="<?php echo $id?>" style=""></a>
        <div class="col checkbox" style="float: left; display: inline; padding: 10px; margin: 0 0 0 0;">
          <input type="checkbox" style="margin-left: 0; float: none;" id="attachment-internal-id-<?php echo $id ?>" name="attachment-internal-id-<?php echo $id ?>" />
        </div>
