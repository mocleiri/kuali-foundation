                ...
                <div class="col-md-9">
                    <main id="LabsProposal-Page" class="uif-page" data-server_messages="false" data-role="Page" data-parent="LabsProposal">
                        ...
                        <div class="uif-cssGridSection uif-boxLayoutVerticalItem clearfix">
                            <div class="row">
                                <div class="col-md-12">
                                    <a class="btn btn-default btn-large uif-modal" data-modal="/kboot/modals/create-version.php" href="#" data-toggle="modal" data-target="#modal-create-version">Create a new budget version</a>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="uif-cssGridSection uif-boxLayoutVerticalItem clearfix" data-parent="LabsProposal-Page">
                            <div class="row ">
                                <div class="col-md-3 uif-cssGridLabelCol">
                                    <label for="uk9itqu_control" class="uif-label displayWith-uk9itqu uif-labelBlock" data-label_for="uk9itqu"> Proposal Type: </label>
                                </div>
                                <div class="col-md-9">
                                    <div class="uif-inputField" data-parent="u1rttg5q" data-role="InputField" data-label="Proposal Type">
                                        <input id="uk9itqu_control" type="text" name="field1" value="" size="30" class="form-control input-sm uif-textControl required" data-role="Control" data-control_for="uk9itqu" >
                                    </div>
                                </div>
                            </div>
                            <div class="row ">
                                <div class="col-md-3 uif-cssGridLabelCol">
                                    <label for="uk9itrp_control" class="uif-label displayWith-uk9itrp uif-labelBlock" data-label_for="uk9itrp"> Project Title: </label>
                                </div>
                                <div class="col-md-9">
                                    <div class="uif-inputField" data-parent="u1rttg5q" data-role="InputField" data-label="Project Title">
                                        <textarea id="uk9itrp_control" name="field2" rows="3" cols="40" class="form-control input-sm uif-mediumTextAreaControl has-helper required" data-role="Control" data-control_for="uk9itrp" ></textarea>
