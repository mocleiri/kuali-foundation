...
var tour = {
  ...
  steps: [
    {
      title: "Proposal Type",
      content: "An identifier for the kind of research project being submitted (i.e., new, resubmission, etc...).",
      target: "#tour1", placement: "top"
    },
	
	    {
      title: "Lead Unit",
      content: "The designated unit responsible for the application and administration of the proposed sponsored project; the lead unit is directly connected to the lead principal investigator. ",
      target: "#tour2", placement: "top"
    },
	
	
	    {
      title: "Activity Type",
      content: "A word or phrase to define the kind of endeavor being proposed (i.e., research, instruction, etc.).  Select from the list to specify the type of activity proposed, (for example, organized research or instruction).",
      target: "#tour3", placement: "top"
    },
      ...
      target: "#tour4", placement: "top"
    },
	
	
	    {
      title: "Project Title",
      content: "The name created to identify the research proposal.  The proposed title of the project. ",
      target: "#tour5", placement: "top"
    },
	
	
	    {
      title: "Sponsor Code",
      content: "A predefined code directly associated with the sponsoring organization (i.e. 000500 = National Science Foundation, 000340 = National Institutes of Health, etc.). The identification number of the organization or agency that is providing support for the sponsored project.  ",
      target: "#tour6", placement: "top"
    },
	
	
	    {
      title: "Keywords",
      content: "A keyword is a term that describes the discipline of a sponsored project (for example, sustainable agriculture or children's literature).",
      target: "#tour7", placement: "top"
    },
