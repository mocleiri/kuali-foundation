...
public class DataDtdMojo extends DataModelTaskMojo {
	 ...
	 * 
	 * @parameter expression="${reportFile}" default-value="../reports/report.${project.artifactId}.datadtd.generation"
	 */
	@SuppressWarnings("unused")
	 ...
	 * 
	 * @parameter expression="${contextPropertiesPath}" default-value="${project.build.directory}/reports/context.datadtd.properties"
	 */
	@SuppressWarnings("unused")
	 ...
	 * 
	 * @parameter expression="${schemaXMLFile}" default-value="${project.build.directory}/generated-impex/${project.artifactId}.xml"
	 * @required
	 */
