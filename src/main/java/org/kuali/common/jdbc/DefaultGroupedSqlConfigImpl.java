...
public class DefaultGroupedSqlConfigImpl implements GroupedSqlConfig {
	...
	public DefaultGroupedSqlConfigImpl(String groupKey, SqlMode sqlMode, Environment environment, JdbcCommonConfig jdbcCommonConfig, JdbcDataSourceConfig dataSourceConfig,
			SqlListener sqlListener) {
