...
import org.kuali.common.jdbc.spring.ResetConfigContext;
...
public class JdbcContextUtils {
    ...
    public static JdbcContext buildJdbcContext(String message, boolean skip, boolean trackProgressByUpdateCount, DataSource dataSource, List<SqlSupplier> suppliers, SqlMode mode, Environment env) {
    ...
    public static JdbcContext buildJdbcContextFromGroupedSql(GroupedSqlConfig groupConfig) {
        ...
        JdbcContext context = buildJdbcContext(message, skip, trackProgressByUpdateCount, groupConfig.getDataSourceConfig().jdbcDataSource(), suppliers, groupConfig.getSqlMode(), groupConfig.getEnvironment());
