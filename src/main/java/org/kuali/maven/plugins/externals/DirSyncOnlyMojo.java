...
/**
 * This mojo examines <code>oldDir</code> for any files that and syncs them <code>newDir</code>.
 * Doesn't alter svn in any way, unlike the DirSyncMojo.
 *
 * @goal dirsynconly
 */

public class DirSyncOnlyMojo extends AbstractMojo {
