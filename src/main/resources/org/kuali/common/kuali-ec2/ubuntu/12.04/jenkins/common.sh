...
function configure_secrets {
  ...
  ZIP=$BASEDIR/${project.groupId.path}/${project.artifactId}/ubuntu/12.04/jenkins/config.zip
  ...
  # setup maven
  rm -rf /root/.m2; mkdir -p /root/.m2/repository;  mv /root/.ssh/settings.xml /root/.m2/settings.xml
