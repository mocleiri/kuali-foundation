...
public class UrlBuilderTest {
	...
	@Test
	public void testGetUrlLatest() {
		DefaultSiteContext context = new DefaultSiteContext();
		context.setLatest(true);
		MavenProjectTest riceModule = getTopLevelRice().getChildren().get(0);
		String url1 = builder.getPublishUrl(riceModule, context);
		String expected1 = "s3://site.origin.kuali.org/rice/latest/rice-core/";
