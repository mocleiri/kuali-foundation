...
(
      CRDT_MEMO_ID NUMBER(9)
        ...
        , CRDT_MEMO_STAT_CD VARCHAR2(4)
        , CRDT_MEMO_NBR VARCHAR2(35) NOT NULL
...
(
      PMT_RQST_ID NUMBER(9)
        ...
        , PMT_RQST_CST_SRC_CD VARCHAR2(4) NOT NULL
...
(
      ACCOUNT_NBR VARCHAR2(40)
        ...
        , OLE_SFC_ENCUM_AMT NUMBER(10,4)
        , OLE_SFC_ENCUM_CON_TYP VARCHAR2(10)
        , OLE_SFC_ENCUM_TYP VARCHAR2(10)
        , OLE_SFC_EXP_METHOD VARCHAR2(10)
        , OLE_SFC_EXP_AMT NUMBER(10,4)
        , OLE_SFC_EXP_CON_TYP VARCHAR2(10)
        , OLE_SFC_EXP_TYP VARCHAR2(10)
        , VER_NBR NUMBER(8) NOT NULL
        , OBJ_ID VARCHAR2(36) NOT NULL
...
(
      ACCS_MTHD_ID NUMBER(8)
        , OBJ_ID VARCHAR2(36) NOT NULL
        , VER_NBR NUMBER(8) NOT NULL
        , ACCS_MTHD_CD VARCHAR2(40) NOT NULL
...
(
      ACQ_MTHD_ID NUMBER(8)
        , OBJ_ID VARCHAR2(36) NOT NULL
        , VER_NBR NUMBER(8) NOT NULL
        , ACQ_MTHD_CD VARCHAR2(40) NOT NULL
...
(
      LND_POL_ID NUMBER(8)
        , LND_POL_CD VARCHAR2(40)
        , LND_POL_NM VARCHAR2(100)
        , SRC VARCHAR2(100)
        , SRC_DT DATE NOT NULL
        , ROW_ACT_IND VARCHAR2(1) NOT NULL
        , OBJ_ID VARCHAR2(36) NOT NULL
...
(
      SPFC_RTN_POL_UNT_TYP_ID VARCHAR2(40)
...
(
      SRC_TRM_ID VARCHAR2(40)
        , SRC_TRM_CD VARCHAR2(40) NOT NULL
        , SRC_TRM_NM VARCHAR2(100) NOT NULL
        , SRC VARCHAR2(100) NOT NULL
        , SRC_DT DATE NOT NULL
        , ROW_ACT_IND VARCHAR2(1) NOT NULL
        , OBJ_ID VARCHAR2(36) NOT NULL
...
(
      TYPE_OWNERSHIP_ID NUMBER(8)
        , OBJ_ID VARCHAR2(36) NOT NULL
        , VER_NBR NUMBER(8) NOT NULL
        , TYPE_OWNERSHIP_CD VARCHAR2(80) NOT NULL
...
DECLARE temp NUMBER;
BEGIN
	SELECT COUNT(*) INTO temp FROM user_tables WHERE table_name = 'OLE_EXT_RQSTR_T';
	IF temp > 0 THEN EXECUTE IMMEDIATE 'DROP TABLE OLE_EXT_RQSTR_T CASCADE CONSTRAINTS PURGE'; END IF;
END;
/

CREATE TABLE OLE_EXT_RQSTR_T
(
      OLE_RQSTR_ID NUMBER(8)
        , OLE_RQSTR_FRST_NM VARCHAR2(45)
        , OLE_RQSTR_EMAIL VARCHAR2(45)
        , OLE_RQSTR_PHN_NBR VARCHAR2(45)
        , OLE_RQSTR_SMS VARCHAR2(45)
        , OLE_RQSTR_LN1_ADDR VARCHAR2(45)
        , OLE_RQSTR_LN2_ADDR VARCHAR2(45)
        , OLE_RQSTR_CTY_NM VARCHAR2(45)
        , POSTAL_STATE_CD VARCHAR2(2)
        , OLE_RQSTR_PSTL_CD VARCHAR2(20)
        , POSTAL_CNTRY_CD VARCHAR2(20)
        , OLE_RQSTR_LST_NM VARCHAR2(45)
        , VER_NBR NUMBER(8) NOT NULL
        , OBJ_ID VARCHAR2(36) NOT NULL
        , ROW_ACTV_IND VARCHAR2(1)
        , OLE_ADDR_INTL_PROV_NM VARCHAR2(45)
        , OLE_RQSTR_TYP_ID NUMBER(8)
        , OLE_REF_KRIM_ID VARCHAR2(20)
    

)
/

ALTER TABLE OLE_EXT_RQSTR_T
    ADD CONSTRAINT OLE_EXT_RQSTR_TP1
PRIMARY KEY (OLE_RQSTR_ID)
/
...
DECLARE temp NUMBER;
BEGIN
	SELECT COUNT(*) INTO temp FROM user_tables WHERE table_name = 'OLE_FP_ACCT_LINES_T';
	IF temp > 0 THEN EXECUTE IMMEDIATE 'DROP TABLE OLE_FP_ACCT_LINES_T CASCADE CONSTRAINTS PURGE'; END IF;
END;
/
...
ALTER TABLE OLE_FP_ACCT_LINES_T
    ADD CONSTRAINT OLE_FP_ACCT_LINES_TP1
PRIMARY KEY (FDOC_NBR,FDOC_LINE_NBR,FDOC_LN_TYP_CD)
/
...
DECLARE temp NUMBER;
BEGIN
	SELECT COUNT(*) INTO temp FROM user_tables WHERE table_name = 'OLE_FP_DISTRIB_DOC_NTE_T';
	IF temp > 0 THEN EXECUTE IMMEDIATE 'DROP TABLE OLE_FP_DISTRIB_DOC_NTE_T CASCADE CONSTRAINTS PURGE'; END IF;
END;
/

CREATE TABLE OLE_FP_DISTRIB_DOC_NTE_T
(
      OLE_FP_DISTRIB_DOC_NTE_ID NUMBER(10)
        , FDOC_NBR VARCHAR2(14)
...
ALTER TABLE OLE_FP_DISTRIB_DOC_NTE_T
    ADD CONSTRAINT OLE_FP_DISTRIB_DOC_NTE_TP1
PRIMARY KEY (OLE_FP_DISTRIB_DOC_NTE_ID,FDOC_NBR)
/
...
DECLARE temp NUMBER;
BEGIN
	SELECT COUNT(*) INTO temp FROM user_tables WHERE table_name = 'OLE_FP_ERROR_COR_DOC_NTE_T';
	IF temp > 0 THEN EXECUTE IMMEDIATE 'DROP TABLE OLE_FP_ERROR_COR_DOC_NTE_T CASCADE CONSTRAINTS PURGE'; END IF;
END;
/

CREATE TABLE OLE_FP_ERROR_COR_DOC_NTE_T
(
      OLE_FP_ERROR_COR_DOC_NTE_ID NUMBER(10)
        , FDOC_NBR VARCHAR2(14)
        , OLE_NTE VARCHAR2(2000) NOT NULL
        , VER_NBR NUMBER(8) NOT NULL
        , OBJ_ID VARCHAR2(36) NOT NULL
...
ALTER TABLE OLE_FP_ERROR_COR_DOC_NTE_T
    ADD CONSTRAINT OLE_FP_ERROR_COR_DOC_NTE_TP1
PRIMARY KEY (OLE_FP_ERROR_COR_DOC_NTE_ID,FDOC_NBR)
/
...
CREATE SEQUENCE OLE_CAT_STAT_SRCH_CD_S INCREMENT BY 1 START WITH 21 NOMAXVALUE NOCYCLE NOCACHE ORDER
/
...
DECLARE temp NUMBER;
BEGIN
	SELECT COUNT(*) INTO temp FROM user_sequences WHERE sequence_name = 'OLE_FP_DISTRIB_DOC_NTE_SEQ';
	IF temp > 0 THEN EXECUTE IMMEDIATE 'DROP SEQUENCE OLE_FP_DISTRIB_DOC_NTE_SEQ'; END IF;
END;
/

CREATE SEQUENCE OLE_FP_DISTRIB_DOC_NTE_SEQ INCREMENT BY 1 START WITH 1 NOMAXVALUE NOCYCLE NOCACHE ORDER
/

DECLARE temp NUMBER;
BEGIN
	SELECT COUNT(*) INTO temp FROM user_sequences WHERE sequence_name = 'OLE_FP_ERROR_COR_DOC_NTE_SEQ';
	IF temp > 0 THEN EXECUTE IMMEDIATE 'DROP SEQUENCE OLE_FP_ERROR_COR_DOC_NTE_SEQ'; END IF;
END;
/

CREATE SEQUENCE OLE_FP_ERROR_COR_DOC_NTE_SEQ INCREMENT BY 1 START WITH 1 NOMAXVALUE NOCYCLE NOCACHE ORDER
/
...
CREATE SEQUENCE OLE_FRMT_ID_S INCREMENT BY 1 START WITH 1 NOMAXVALUE NOCYCLE NOCACHE ORDER
/
...
CREATE SEQUENCE OLE_REQ_SRC_TYP_ID_S INCREMENT BY 1 START WITH 1 NOMAXVALUE NOCYCLE NOCACHE ORDER
/
