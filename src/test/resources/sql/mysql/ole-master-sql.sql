...
(
      ACCOUNT_NBR VARCHAR(40)
        ...
        , OLE_SFC_ENCUM_AMT DECIMAL(10,4)
        , OLE_SFC_ENCUM_CON_TYP VARCHAR(10)
        , OLE_SFC_ENCUM_TYP VARCHAR(10)
        , OLE_SFC_EXP_METHOD VARCHAR(10)
        , OLE_SFC_EXP_AMT DECIMAL(10,4)
        , OLE_SFC_EXP_CON_TYP VARCHAR(10)
        , OLE_SFC_EXP_TYP VARCHAR(10)
        , VER_NBR DECIMAL(8) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
...
(
      ACCS_MTHD_ID DECIMAL(8)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) NOT NULL
        , ACCS_MTHD_CD VARCHAR(40) NOT NULL
    ...
    , CONSTRAINT ACCS_MTHD_CD_UQ UNIQUE (ACCS_MTHD_CD)
...
(
      ACQ_MTHD_ID DECIMAL(8)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) NOT NULL
        , ACQ_MTHD_CD VARCHAR(40) NOT NULL
    ...
    , CONSTRAINT ACQ_MTHD_CD_UQ UNIQUE (ACQ_MTHD_CD)
...
(
    ...
    , CONSTRAINT ACTION_CD_UQ UNIQUE (ACTION_CD)
...
(
    ...
    , CONSTRAINT CMPLT_CD_UQ UNIQUE (CMPLT_CD)
...
(
    ...
    , CONSTRAINT ELE_RLSHP_CD_UQ UNIQUE (ELE_RLSHP_CD)
...
(
    ...
    , CONSTRAINT ENCD_LVL_CD_UQ UNIQUE (ENCD_LVL_CD)
...
(
    ...
    , CONSTRAINT FLD_ENCD_LVL_CD_UQ UNIQUE (FLD_ENCD_LVL_CD)
...
(
    ...
    , CONSTRAINT GEN_RTN_POL_CD_UQ UNIQUE (GEN_RTN_POL_CD)
...
(
    ...
    , CONSTRAINT ITM_TYP_CD_UQ UNIQUE (ITM_TYP_CD)
...
(
      LND_POL_ID DECIMAL(8)
        , LND_POL_CD VARCHAR(40)
        , LND_POL_NM VARCHAR(100)
        , SRC VARCHAR(100)
        , SRC_DT DATETIME NOT NULL
        , ROW_ACT_IND VARCHAR(1) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    ...
    , CONSTRAINT LND_POL_CD_UQ UNIQUE (LND_POL_CD)
...
(
    ...
    , CONSTRAINT COUNTRY_CD_UQ UNIQUE (LOC_COUNTRY_CD)
...
(
    ...
    , CONSTRAINT NTN_TYP_CD_UQ UNIQUE (NTN_TYP_CD)
...
(
    ...
    , CONSTRAINT PRVCY_CD_UQ UNIQUE (PRVCY_CD)
...
(
    ...
    , CONSTRAINT RCPT_STAT_CD_UQ UNIQUE (RCPT_STAT_CD)
...
(
    ...
    , CONSTRAINT REC_TYP_CD_UQ UNIQUE (REC_TYP_CD)
...
(
    ...
    , CONSTRAINT REPRO_POL_CD_UQ UNIQUE (REPRO_POL_CD)
...
(
    ...
    , CONSTRAINT SHVLG_ORD_CD_UQ UNIQUE (SHVLG_ORD_CD)
...
(
    ...
    , CONSTRAINT SHVLG_SCHM_CD_UQ UNIQUE (SHVLG_SCHM_CD)
...
(
    ...
    , CONSTRAINT SPCP_RPT_CD_UQ UNIQUE (SPCP_RPT_CD)
...
(
    ...
    , CONSTRAINT SPFC_RTN_POL_TYP_CD_UQ UNIQUE (SPFC_RTN_POL_TYP_CD)
...
(
      SPFC_RTN_POL_UNT_TYP_ID VARCHAR(40)
    ...
    , CONSTRAINT SPFC_RTN_POL_UNT_TYP_CD_UQ UNIQUE (SPFC_RTN_POL_UNT_TYP_CD)
...
(
      SRC_TRM_ID VARCHAR(40)
        , SRC_TRM_CD VARCHAR(40) NOT NULL
        , SRC_TRM_NM VARCHAR(100) NOT NULL
        , SRC VARCHAR(100) NOT NULL
        , SRC_DT DATETIME NOT NULL
        , ROW_ACT_IND VARCHAR(1) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    ...
    , CONSTRAINT SRC_TRM_CD_UQ UNIQUE (SRC_TRM_CD)
...
(
    ...
    , CONSTRAINT STAT_SRCH_CD_UQ UNIQUE (STAT_SRCH_CD)
...
(
      TYPE_OWNERSHIP_ID DECIMAL(8)
        , OBJ_ID VARCHAR(36) NOT NULL
        , VER_NBR DECIMAL(8) NOT NULL
        , TYPE_OWNERSHIP_CD VARCHAR(80) NOT NULL
    ...
    , CONSTRAINT TYPE_OWNERSHIP_CD_UQ UNIQUE (TYPE_OWNERSHIP_CD)
...
# OLE_EXT_RQSTR_T
# -----------------------------------------------------------------------
drop table if exists OLE_EXT_RQSTR_T
/

CREATE TABLE OLE_EXT_RQSTR_T
(
      OLE_RQSTR_ID DECIMAL(8)
        , OLE_RQSTR_FRST_NM VARCHAR(45)
        , OLE_RQSTR_EMAIL VARCHAR(45)
        , OLE_RQSTR_PHN_NBR VARCHAR(45)
        , OLE_RQSTR_SMS VARCHAR(45)
        , OLE_RQSTR_LN1_ADDR VARCHAR(45)
        , OLE_RQSTR_LN2_ADDR VARCHAR(45)
        , OLE_RQSTR_CTY_NM VARCHAR(45)
        , POSTAL_STATE_CD VARCHAR(2)
        , OLE_RQSTR_PSTL_CD VARCHAR(20)
        , POSTAL_CNTRY_CD VARCHAR(20)
        , OLE_RQSTR_LST_NM VARCHAR(45)
        , VER_NBR DECIMAL(8) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
        , ROW_ACTV_IND VARCHAR(1)
        , OLE_ADDR_INTL_PROV_NM VARCHAR(45)
        , OLE_RQSTR_TYP_ID DECIMAL(8)
        , OLE_REF_KRIM_ID VARCHAR(20)
    
    , CONSTRAINT OLE_EXT_RQSTR_TP1 PRIMARY KEY(OLE_RQSTR_ID)
...
# OLE_FP_ACCT_LINES_T
# -----------------------------------------------------------------------
drop table if exists OLE_FP_ACCT_LINES_T
/

CREATE TABLE OLE_FP_ACCT_LINES_T
(
      FDOC_NBR VARCHAR(14)
        , FDOC_LINE_NBR DECIMAL(7)
        , FDOC_LN_TYP_CD VARCHAR(1)
    ...
    , CONSTRAINT OLE_FP_ACCT_LINES_TP1 PRIMARY KEY(FDOC_NBR,FDOC_LINE_NBR,FDOC_LN_TYP_CD)

    , CONSTRAINT OLE_FP_ACCT_LINES_TC0 UNIQUE (OBJ_ID)
...
# -----------------------------------------------------------------------
# OLE_FP_DISTRIB_DOC_NTE_T
# -----------------------------------------------------------------------
drop table if exists OLE_FP_DISTRIB_DOC_NTE_T
/

CREATE TABLE OLE_FP_DISTRIB_DOC_NTE_T
(
      OLE_FP_DISTRIB_DOC_NTE_ID DECIMAL(10)
        , FDOC_NBR VARCHAR(14)
        , OLE_NTE VARCHAR(2000) NOT NULL
        , VER_NBR DECIMAL(8) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    
    , CONSTRAINT OLE_FP_DISTRIB_DOC_NTE_TP1 PRIMARY KEY(OLE_FP_DISTRIB_DOC_NTE_ID,FDOC_NBR)
...
# -----------------------------------------------------------------------
# OLE_FP_ERROR_COR_DOC_NTE_T
# -----------------------------------------------------------------------
drop table if exists OLE_FP_ERROR_COR_DOC_NTE_T
/

CREATE TABLE OLE_FP_ERROR_COR_DOC_NTE_T
(
      OLE_FP_ERROR_COR_DOC_NTE_ID DECIMAL(10)
        , FDOC_NBR VARCHAR(14)
        , OLE_NTE VARCHAR(2000) NOT NULL
        , VER_NBR DECIMAL(8) NOT NULL
        , OBJ_ID VARCHAR(36) NOT NULL
    
    , CONSTRAINT OLE_FP_ERROR_COR_DOC_NTE_TP1 PRIMARY KEY(OLE_FP_ERROR_COR_DOC_NTE_ID,FDOC_NBR)
...
/
ALTER TABLE OLE_CAT_STAT_SRCH_CD_S auto_increment = 21
/
...
# -----------------------------------------------------------------------
# OLE_FP_DISTRIB_DOC_NTE_SEQ
# -----------------------------------------------------------------------
drop table if exists OLE_FP_DISTRIB_DOC_NTE_SEQ
/

CREATE TABLE OLE_FP_DISTRIB_DOC_NTE_SEQ
(
	id bigint(19) not null auto_increment, primary key (id) 
) ENGINE MyISAM
/
ALTER TABLE OLE_FP_DISTRIB_DOC_NTE_SEQ auto_increment = 1
/

# -----------------------------------------------------------------------
# OLE_FP_ERROR_COR_DOC_NTE_SEQ
# -----------------------------------------------------------------------
drop table if exists OLE_FP_ERROR_COR_DOC_NTE_SEQ
/

CREATE TABLE OLE_FP_ERROR_COR_DOC_NTE_SEQ
(
	id bigint(19) not null auto_increment, primary key (id) 
) ENGINE MyISAM
/
ALTER TABLE OLE_FP_ERROR_COR_DOC_NTE_SEQ auto_increment = 1
/
...
/
ALTER TABLE OLE_FRMT_ID_S auto_increment = 1
/
...
/
ALTER TABLE OLE_REQ_SRC_TYP_ID_S auto_increment = 1
/
