...
/**
 * This condition being met means that Amazon has verified that the instance is running, connected to the network, and the operating system is accepting traffic.
 */
