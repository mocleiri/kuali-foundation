...
public class LaunchInstanceExecutable implements Executable {
	...
	private final LaunchInstanceRequest request;
	private final boolean skip;

	public LaunchInstanceExecutable(EC2Service service, LaunchInstanceRequest request) {
		this(service, request, false);
	}

	public LaunchInstanceExecutable(EC2Service service, LaunchInstanceRequest request, boolean skip) {
	...
	public LaunchInstanceRequest getRequest() {
		return request;
	}
