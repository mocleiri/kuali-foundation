...
public final class Reachability {
	...
	/**
	 * This string indicates the ability of AWS to get traffic to the operating system of the instance. If this check fails, the instance may need to be rebooted or have
	 * modifications made to the operating system configuration.
	 */
