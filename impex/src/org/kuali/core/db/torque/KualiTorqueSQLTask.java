...
public class KualiTorqueSQLTask extends TexenTask {
    ...
    public KualiDatabase getDatabaseFromXml(String xmlFile) throws Exception {
        KualiDatabase retval = null;
    ...
    public Context initControlContext() throws Exception {
        ...
        try {
            if (xmlFile != null) {
                dataModels.add(getDatabaseFromXml(xmlFile));
            }
            else {
                ...
                for (int i = 0; i < filesets.size(); i++) {
                    ...
                    for (int j = 0; j < dataModelFiles.length; j++) {
                        ...
                        dataModels.add(getDatabaseFromXml(f.toString()));
                     }
                }
            }
    ...
    /**
     * Map of data model name to database name. Should probably stick to the convention of them being the same but I know right now
