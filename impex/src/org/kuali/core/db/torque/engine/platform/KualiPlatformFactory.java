...
/**
 * Factory class responsible to create Platform objects that define RDBMS
 * platform specific behaviour.
 * 
 * @author Thomas Mahler
 * @author <a href="mailto:mpoeschl@marmot.at">Martin Poeschl</a>
 * @version $Id: KualiPlatformFactory.java,v 1.1.2.1 2008-03-12 09:24:59 lprzybyl Exp $
 */
public class KualiPlatformFactory {
	private static HashMap platforms = new HashMap();
	private static Log log = LogFactory.getLog(KualiPlatformFactory.class);
	...
	private static String getClassnameFor(String platform) {
		...
		return "org.kuali.core.db.torque.engine.platform.Platform"
