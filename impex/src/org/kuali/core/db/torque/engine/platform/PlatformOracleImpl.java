 ...
 * @version $Id: PlatformOracleImpl.java,v 1.1.2.1 2008-03-12 09:24:59 lprzybyl Exp $
 */
public class PlatformOracleImpl extends PlatformDefaultImpl {
	...
	private void initialize() {
		setSchemaDomainMapping(new Domain(SchemaType.TINYINT, "NUMBER", "3",
				"0"));
		setSchemaDomainMapping(new Domain(SchemaType.SMALLINT, "NUMBER", "5",
				"0"));
		setSchemaDomainMapping(new Domain(SchemaType.INTEGER, "NUMBER", "10",
				"0"));
		setSchemaDomainMapping(new Domain(SchemaType.BOOLEANINT, "NUMBER", "1",
				"0"));
		...
		setSchemaDomainMapping(new Domain(SchemaType.LONGVARCHAR, "VARCHAR2",
				"2000"));
