 ...
 * @version $Id: PlatformDerbyImpl.java,v 1.1.2.1 2008-03-12 09:24:59 lprzybyl Exp $
 */
public class PlatformDerbyImpl extends PlatformDefaultImpl {
	...
	private void initialize() {
		...
		setSchemaDomainMapping(new SizedForBitDataDomain(SchemaType.VARBINARY,
				"VARCHAR", "32672"));
		setSchemaDomainMapping(new SizedForBitDataDomain(SchemaType.BINARY,
				"CHAR", "1"));
