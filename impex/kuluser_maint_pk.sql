...
IS
    ...
    ProtectedSchemaList CONSTANT VARCHAR2(4000) := '~SYS~SYSTEM~DBSNMP~OUTLN~DIP~TSMSYS~WMSYS~KULDBA~';
    AllowedSchemaPrefixList CONSTANT VARCHAR2(4000) := 'KUL,RICE,KR,KRA,KEW,KEM,KS';
