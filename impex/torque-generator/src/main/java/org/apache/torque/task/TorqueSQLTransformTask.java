...
public class TorqueSQLTransformTask extends Task {
    ...
    /**
     * Set the current output file. If the file does not exist it will be created. If the file exists all it's contents
     * will be replaced.
     * 
     * @param v
     *            the output file
     ...
     *             Any exceptions caught during procssing will be rethrown wrapped into a BuildException
     */
