...
public class NameFactory {
    ...
    /**
     * The cache of <code>NameGenerator</code> algorithms in use for name generation, keyed by fully qualified class
     * name.
     */
     ...
     * 
     * @param name
     *            The fully qualified class name of the name generation algorithm to retrieve.
     ...
     * 
     * @param algorithmName
     *            The fully qualified class name of the {@link org.apache.torque.engine.database.model.NameGenerator}
