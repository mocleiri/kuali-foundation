              ...
              <h4>About this page</h4>
               ...
               <p>Use this page to identify the faculty member or senior researcher who is the Principal Investigator (PI) of the proposal, any additional Co-Investigators (Co-I), and project Key Persons (other Key Personnel).</p>
                ...
                <ul class="nav nav-tabs" style="display:block" >
                  ...
                  <li class="">
                  <a href="#asdf" data-toggle="tab">Turner, Joe</a>
                </li>
                
                  <li class="">
                  <a href="#sdfg" data-toggle="tab">Edwards, Mary</a>
                </li>
                
                  <li class="">
                  <a href="#dfgh" data-toggle="tab">Baker, Lyda</a>
                </li>
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="art">
                    <div class="boxSubheader">
                      ...
                      <div class="boxControls"> <a href="#" class="ajax-modal" data-backdrop="true" data-controls-modal="deletepersonnel" data-keyboard="true" url="modal-reorderpersonnel/frame.html">reorder</a> | <a href="#" class="ajax-modal" data-backdrop="true" data-controls-modal="deletepersonnel" data-keyboard="true" url="modal-deletepersonnel/frame.html">delete</a> </div>
                    </div>
                    ...
                    <div class="expandTarget" style="display:none">
                      <dl class="table-display" style="margin-top:-13px;">
                        ...
                        <dd>&nbsp; </dd>
                        <dt>Full Name</dt>
                        <dd> <a href="#" id="username" data-type="text" data-pk="1" data-url="/post" data-original-title="Enter Full Name">Haskell, Edward</a> </dd>
                        <dt>User Name </dt>
                        <dd>arttatum</dd>
                        <dt>Email Address</dt>
                        <dd> <a href="#" id="email" data-type="text" data-pk="1" data-url="/post" data-original-title="Enter Email">arttatum@indiana.edu</a> </dd>
                        <dt>Office Phone</dt>
                        <dd>  <a href="#" id="tags" data-type="text" data-pk="1" data-url="/post" data-original-title="Enter Phone">(812) 855-7441</a> </dd>
                        <dt>Primary Title</dt>
...
<div class="docControls"> <a href="prop.basics.keywords.php" class="btn"><i class="icon-chevron-left"></i> Back</a> <a href="#" class="btn">Save</a> <a href="prop.keypersonnel.creditintel.php" class="btn btn-inverse">Save and Continue <i class="icon-white icon-chevron-right"></i></a> </div>
