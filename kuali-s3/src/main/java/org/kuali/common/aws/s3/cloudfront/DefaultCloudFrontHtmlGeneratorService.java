...
public class DefaultCloudFrontHtmlGeneratorService implements CloudFrontHtmlGeneratorService {
	...
	public String getDirectoryListing(CloudFrontHtmlGeneratorContext context, String prefix, List<String[]> data) {
		...
		sb.append(HtmlUtils.getTag(span2, getAbout(context.getProject()), indent));
	...
	protected String getAbout(Project project) {
		StringBuilder sb = new StringBuilder();
		sb.append("Listing generated by");
		sb.append(" ");
		...
		sb.append("on");
		sb.append(" ");
		sb.append(FormatUtils.getDate(System.currentTimeMillis()));
		return sb.toString();
	}
