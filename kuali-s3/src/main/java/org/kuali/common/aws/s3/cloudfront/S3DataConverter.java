...
public class S3DataConverter {
	 ...
	 */
	public String getTrimmedPrefix(final String prefix, final String delimiter) {
	...
	protected List<DisplayRow> getDirectoryDisplayRows(final ObjectListing objectListing, final String prefix, final String delimiter) {
	...
	protected List<DisplayRow> getObjectDisplayRows(final ObjectListing objectListing, final String prefix, final String delimiter) {
		List<DisplayRow> displayRows = new ArrayList<DisplayRow>();
