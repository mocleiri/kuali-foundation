...
public class ModularDataExportConfig {
    ...
    public static final String PROPERTY_PREFIXES_KEY = "jalc.export.data.modular.prefixes";

    public static final String STATISTICS_LOCATION_KEY = "jalc.export.data.statistics.location";
