...
public final class HttpConfig {
	...
	public static class Builder implements org.apache.commons.lang3.builder.Builder<HttpConfig> {
		...
		public HttpConfig build() {
			HttpConfig instance = new HttpConfig(this);
			validate(instance);
			return instance;
		}

		private static void validate(HttpConfig instance) {
