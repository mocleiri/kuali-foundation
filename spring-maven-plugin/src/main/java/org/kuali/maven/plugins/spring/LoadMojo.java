 ...
 * file is automatically added to the properties under the key <code>maven.spring.properties</code>. This combination allows the injection
 * of Maven properties into a Spring context by setting <code>filterContext=true</code> in the Maven pom and adding one line to the Spring
