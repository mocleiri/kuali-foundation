...
<section>
  <div class="sectionContents col2">
    ...
    <div class="container leftnav">
      <?php require_once( 'assets/inc/document-header-routing.php' ) ?>
            ...
            <div class="span12 content">
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="Summary"> 
                  ...
                  <!-- Proposal Summary -->
                  <div class="summary">
                    <div class="boxHeader expandControl closed panelhead">
                      <h4>Proposal Summary</h4>
                    </div>
                    <div class="boxContent expandTarget" style="min-height:300px; display:none"> 
                            ...
                            <td style="text-align:left" colspan="4"><div class="boxSubheader expandControl closed">
                              ...
                              <div class="expandTarget" style="display:none">
                                <fieldset class="question">
                                  ...
                                  <div class="questionControls"> <img src="./assets/img/uncheck_box16.png" alt="unchecked" style="height:16px; width:17px; border:none; margin-left:15px;"> Yes <img src="./assets/img/uncheck_box16.png" alt="unchecked" style="height:16px; width:17px; border:none; margin-left:15px;"> No </div>
                                </fieldset>
                                <fieldset class="question">
                          ...
                          <tr>
                            <td style="text-align:left" colspan="4"><div class="boxSubheader expandControl closed">
                              ...
                              <div class="expandTarget" style="display:none">
                                <fieldset class="question">
                                  <span>I certify that (1) all information provided in this request or application is true, complete and accurate to the best of my knowledge and (2) I understand that any false, fictitious, or fraudulent statements or claims may subject me to criminal, civil or administrative penalties.</span>
                                  <div class="questionControls"> <img src="./assets/img/check_box16.png" alt="checked" style="height:16px; width:17px; border:none; margin-left:15px;"> Yes <img src="./assets/img/uncheck_box16.png" alt="unchecked" style="height:16px; width:17px; border:none; margin-left:15px;"> No </div>
                                </fieldset>
                                <fieldset class="question">
                                  <span>I certify that I agree to accept responsibility for the scientific conduct of the project, to provide the required progress reports, and to comply with the terms and conditions of the sponsoring agency.</span>
                                  <div class="questionControls"> <img src="./assets/img/check_box16.png" alt="checked" style="height:16px; width:17px; border:none; margin-left:15px;"> Yes <img src="./assets/img/uncheck_box16.png" alt="unchecked" style="height:16px; width:17px; border:none; margin-left:15px;"> No </div>
                                ...
                                <fieldset class="question">
                                  <span>Do you have a financial conflict of interest related to this project? For help, see http://researchadmin.iu.edu/COI/coi_home.html</span>
                                  <div class="questionControls"> <img src="./assets/img/uncheck_box16.png" alt="unchecked" style="height:16px; width:17px; border:none; margin-left:15px;"> Yes <img src="./assets/img/check_box16.png" alt="checked" style="height:16px; width:17px; border:none; margin-left:15px;"> No </div>
                                </fieldset>
                                <fieldset class="question">
                                  <span>If application is to a federal or federal pass-through sponsor, have any lobbying activities been or will any be conducted regarding this proposal?</span>
                                  <div class="questionControls"> <img src="./assets/img/uncheck_box16.png" alt="unchecked" style="height:16px; width:17px; border:none; margin-left:15px;"> Yes <img src="./assets/img/check_box16.png" alt="checked" style="height:16px; width:17px; border:none; margin-left:15px;"> No </div>
                  ...
                  <div class="summary">
                    ...
                    <div class="boxContent expandTarget" style="min-height:500px; display:none">
                  ...
                  <div class="box">
                    ...
                    <div class="boxContent">
                      <div class="well" style="padding-bottom: 19px !important; margin-bottom:30px;">
                        ...
                        <a href="#" class="btn btn-success">Approve</a> <a href="#" class="btn btn-danger">Reject</a> <a href="#" class="btn">Recall</a> <a href="#" class="btn">Send Notification</a> <a href="#" class="btn btn-inverse pull-right">Submit to Sponsor</a> </div>
                      <div class="boxSubheader">
                        <h4>Comments</h4>
                      </div>
...
$(function () {
  $('#myTab a:first').tab('show');
      ...
      <div class="docControls"> <a href="http://localhost/kuali/prototype-c/prop.instspecdata.3.php" class="btn"><i class="icon-chevron-left"></i> Back</a> 
