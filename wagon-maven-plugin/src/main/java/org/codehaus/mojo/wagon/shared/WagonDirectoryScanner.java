...
public class WagonDirectoryScanner {
     ...
     *
     * @param includes
     *            A list of include patterns. May be <code>null</code>, indicating that all files should be included. If
     *            a non-<code>null</code> list is given, all elements must be non-<code>null</code>.
     */
     ...
     *
     * @param excludes
     *            A list of exclude patterns. May be <code>null</code>, indicating that no files should be excluded. If
     *            a non-<code>null</code> list is given, all elements must be non-<code>null</code>.
     */
